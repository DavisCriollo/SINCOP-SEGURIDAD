...
class AllPersonasDesignadas {
  ...
  factory AllPersonasDesignadas.fromJson(String str) =>
      AllPersonasDesignadas.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllPersonasDesignadas.fromMap(Map<String, dynamic> json) =>
      AllPersonasDesignadas(
        data: List<InfoPersona>.from(
            json["data"].map((x) => InfoPersona.fromMap(x))),
      );
...
class InfoPersona {
  ...
  factory InfoPersona.fromJson(String str) =>
      InfoPersona.fromMap(json.decode(str));
