...
class AllInformesGuardias {
  ...
  factory AllInformesGuardias.fromJson(String str) =>
      AllInformesGuardias.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllInformesGuardias.fromMap(Map<String, dynamic> json) =>
      AllInformesGuardias(
...
class Informe {
  ...
  factory Informe.fromMap(Map<String, dynamic> json) => Informe(
        ...
        infGuardias: List<InfGuardia>.from(
            json["infGuardias"].map((x) => InfGuardia.fromMap(x))),
...
class InfGuardia {
  ...
  factory InfGuardia.fromJson(String str) =>
      InfGuardia.fromMap(json.decode(str));
