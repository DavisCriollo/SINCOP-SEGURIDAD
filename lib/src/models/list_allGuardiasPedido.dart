...
class AllGuardiasPedido {
  ...
  factory AllGuardiasPedido.fromJson(String str) =>
      AllGuardiasPedido.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllGuardiasPedido.fromMap(Map<String, dynamic> json) =>
      AllGuardiasPedido(
...
class Guardia {
  ...
  factory Guardia.fromMap(Map<String, dynamic> json) => Guardia(
        ...
        perPuestoServicio: List<PerPuestoServicio>.from(
            json["perPuestoServicio"].map((x) => PerPuestoServicio.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "perFecNacimiento":
            "${perFecNacimiento!.year.toString().padLeft(4, '0')}-${perFecNacimiento!.month.toString().padLeft(2, '0')}-${perFecNacimiento!.day.toString().padLeft(2, '0')}",
        "perCiudad": perCiudad,
        ...
        "perFecVinculacion":
            "${perFecVinculacion!.year.toString().padLeft(4, '0')}-${perFecVinculacion!.month.toString().padLeft(2, '0')}-${perFecVinculacion!.day.toString().padLeft(2, '0')}",
        ...
        "perPuestoServicio":
            List<dynamic>.from(perPuestoServicio!.map((x) => x.toMap())),
...
class PerPuestoServicio {
  ...
  factory PerPuestoServicio.fromJson(String str) =>
      PerPuestoServicio.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PerPuestoServicio.fromMap(Map<String, dynamic> json) =>
      PerPuestoServicio(
