                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        final _fecha = DateUtility.fechaLocalConvert(
                            cierreBit['bitcFecReg']);
                            ...
                            children: [
                              widget.user!.usuario == cierreBit['bitcUsuario']
                                  ? SlidableAction(
                                      ...
                                      // label: 'Editar',
                                      onPressed: (context) {
                                        provider.copiaCierreBitacora(
                                            context, cierreBit);
                                        provider.buscaBitacorasCierre(
                                            '', 'false');
                                      },
                                    )
                                  : Container(),
                              widget.user!.usuario ==
                                          cierreBit['bitcUsuario'] &&
                                      cierreBit['bitcEstado'] != 'ANULADA'
                                  ? SlidableAction(
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: GoogleFonts.lexendDeca(
                                                fontSize: size.iScreen(1.6),
                                                color: _colorEstado(cierreBit[
                                                    'bitcEstado']), //_colorEstado,
