...
class ConsignaClientePage extends StatefulWidget {
  const ConsignaClientePage({super.key});
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: consignaController
                                              .getLitaSeleccionada !=
                                          null
                                      ? Wrap(
                                          alignment: WrapAlignment.center,
                                          children: consignaController
                                              .getLitaSeleccionada!
                                              .map(
                                                (e) => Container(
...
class ItemNominaGuardias extends StatelessWidget {
  ...
  const ItemNominaGuardias(
      {super.key, required this.nomina, required this.size});
