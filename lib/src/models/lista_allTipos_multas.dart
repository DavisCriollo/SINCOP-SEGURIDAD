...
class AllTiposMultasGuardias {
  ...
  factory AllTiposMultasGuardias.fromJson(String str) =>
      AllTiposMultasGuardias.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllTiposMultasGuardias.fromMap(Map<String, dynamic> json) =>
      AllTiposMultasGuardias(
        data:
            List<TipoMulta>.from(json["data"].map((x) => TipoMulta.fromMap(x))),
      );
...
class TipoMulta {
  ...
  factory TipoMulta.fromMap(Map<String, dynamic> json) => TipoMulta(
        ...
        novlista: List<ListaTipoMulta>.from(
            json["novlista"].map((x) => ListaTipoMulta.fromMap(x))),
...
class ListaTipoMulta {
  ...
  factory ListaTipoMulta.fromJson(String str) =>
      ListaTipoMulta.fromMap(json.decode(str));
