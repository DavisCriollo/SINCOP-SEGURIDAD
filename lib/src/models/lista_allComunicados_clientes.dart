...
class AllCumunicadosClientes {
  ...
  factory AllCumunicadosClientes.fromJson(String str) =>
      AllCumunicadosClientes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllCumunicadosClientes.fromMap(Map<String, dynamic> json) =>
      AllCumunicadosClientes(
