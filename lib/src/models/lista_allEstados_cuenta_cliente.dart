...
class AllEstadosCuentaCliente {
  ...
  factory AllEstadosCuentaCliente.fromJson(String str) =>
      AllEstadosCuentaCliente.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllEstadosCuentaCliente.fromMap(Map<String, dynamic> json) =>
      AllEstadosCuentaCliente(
...
class Result {
  ...
  factory Result.fromMap(Map<String, dynamic> json) => Result(
        ...
        estCuotas: List<EstCuota>.from(
            json["estCuotas"].map((x) => EstCuota.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "estFecInicio":
            "${estFecInicio!.year.toString().padLeft(4, '0')}-${estFecInicio!.month.toString().padLeft(2, '0')}-${estFecInicio!.day.toString().padLeft(2, '0')}",
        "estFecFinal":
            "${estFecFinal!.year.toString().padLeft(4, '0')}-${estFecFinal!.month.toString().padLeft(2, '0')}-${estFecFinal!.day.toString().padLeft(2, '0')}",
