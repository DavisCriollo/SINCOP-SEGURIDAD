...
class AllClientes {
  ...
  factory AllClientes.fromJson(String str) =>
      AllClientes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllClientes.fromMap(Map<String, dynamic> json) => AllClientes(
        data: List<InfoCliente>.from(
            json["data"].map((x) => InfoCliente.fromMap(x))),
      );
...
class InfoCliente {
  ...
  factory InfoCliente.fromJson(String str) =>
      InfoCliente.fromMap(json.decode(str));
  ...
  factory InfoCliente.fromMap(Map<String, dynamic> json) => InfoCliente(
        ...
        cliTiempoInicioContrato:
            DateTime.parse(json["cliTiempoInicioContrato"]),
        cliTiempoFinalContrato: DateTime.parse(json["cliTiempoFinalContrato"]),
        cliAdministradorContrato: json["cliAdministradorContrato"],
        cliDatosOperativos: List<CliDatosOperativo>.from(
            json["cliDatosOperativos"]
                .map((x) => CliDatosOperativo.fromMap(x))),
        cliArmasAsignadas:
            List<dynamic>.from(json["cliArmasAsignadas"].map((x) => x)),
        cliEquiposAsignados:
            List<dynamic>.from(json["cliEquiposAsignados"].map((x) => x)),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "cliTiempoInicioContrato":
            "${cliTiempoInicioContrato!.year.toString().padLeft(4, '0')}-${cliTiempoInicioContrato!.month.toString().padLeft(2, '0')}-${cliTiempoInicioContrato!.day.toString().padLeft(2, '0')}",
        "cliTiempoFinalContrato":
            "${cliTiempoFinalContrato!.year.toString().padLeft(4, '0')}-${cliTiempoFinalContrato!.month.toString().padLeft(2, '0')}-${cliTiempoFinalContrato!.day.toString().padLeft(2, '0')}",
        "cliAdministradorContrato": cliAdministradorContrato,
        "cliDatosOperativos":
            List<dynamic>.from(cliDatosOperativos!.map((x) => x.toMap())),
        "cliArmasAsignadas":
            List<dynamic>.from(cliArmasAsignadas!.map((x) => x)),
        "cliEquiposAsignados":
            List<dynamic>.from(cliEquiposAsignados!.map((x) => x)),
...
class CliDatosOperativo {
  ...
  factory CliDatosOperativo.fromJson(String str) =>
      CliDatosOperativo.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CliDatosOperativo.fromMap(Map<String, dynamic> json) =>
      CliDatosOperativo(
...
class CliUbicacion {
  ...
  factory CliUbicacion.fromJson(String str) =>
      CliUbicacion.fromMap(json.decode(str));
...
class Documentos {
  ...
  factory Documentos.fromJson(String str) =>
      Documentos.fromMap(json.decode(str));
  ...
  factory Documentos.fromMap(Map<String, dynamic> json) => Documentos(
        ...
        actaentregarecepciondefinitivaexpira:
            json["actaentregarecepciondefinitivaexpira"],
      );
