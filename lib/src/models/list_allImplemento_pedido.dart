...
class AllImplementoPedido {
  ...
  factory AllImplementoPedido.fromJson(String str) =>
      AllImplementoPedido.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllImplementoPedido.fromMap(Map<String, dynamic> json) =>
      AllImplementoPedido(
        data: List<Implemento>.from(
            json["data"].map((x) => Implemento.fromMap(x))),
      );
...
class Implemento {
  ...
  factory Implemento.fromJson(String str) =>
      Implemento.fromMap(json.decode(str));
  ...
  factory Implemento.fromMap(Map<String, dynamic> json) => Implemento(
        ...
        invProveedor: List<InvProveedor>.from(
            json["invProveedor"].map((x) => InvProveedor.fromMap(x))),
...
class InvProveedor {
  ...
  factory InvProveedor.fromJson(String str) =>
      InvProveedor.fromMap(json.decode(str));
  ...
  Map<String, dynamic> toMap() => {
        ...
        "cantidad": cantidad,
        "fecFactura":
            "${fecFactura!.year.toString().padLeft(4, '0')}-${fecFactura!.month.toString().padLeft(2, '0')}-${fecFactura!.day.toString().padLeft(2, '0')}",
      };
}
