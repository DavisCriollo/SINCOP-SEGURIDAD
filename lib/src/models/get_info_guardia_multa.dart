...
class AllGuardias {
  ...
  factory AllGuardias.fromJson(String str) =>
      AllGuardias.fromMap(json.decode(str));
...
class Guardia {
  ...
  factory Guardia.fromMap(Map<String, dynamic> json) => Guardia(
        ...
        perPuestoServicio:
            List<dynamic>.from(json["perPuestoServicio"].map((x) => x)),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "perPuestoServicio":
            List<dynamic>.from(perPuestoServicio!.map((x) => x)),
