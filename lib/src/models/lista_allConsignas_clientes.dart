...
class AllConsignasClientes {
  ...
  factory AllConsignasClientes.fromJson(String str) =>
      AllConsignasClientes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllConsignasClientes.fromMap(Map<String, dynamic> json) =>
      AllConsignasClientes(
...
class Result {
  ...
  factory Result.fromMap(Map<String, dynamic> json) => Result(
        ...
        conFotosCliente: json["conFotosCliente"] == null
            ? null
            : List<ConFotosCliente>.from(
                json["conFotosCliente"].map((x) => ConFotosCliente.fromMap(x))),
        conLeidos: List<dynamic>.from(json["conLeidos"].map((x) => x)),
        conDiasRepetir: List<String>.from(json["conDiasRepetir"].map((x) => x)),
        conAsignacion: List<ConAsignacion>.from(
            json["conAsignacion"].map((x) => ConAsignacion.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "conFotosCliente": conFotosCliente == null
            ? null
            : List<dynamic>.from(conFotosCliente!.map((x) => x.toMap())),
        "conLeidos": List<dynamic>.from(conLeidos!.map((x) => x)),
        "conDiasRepetir": List<dynamic>.from(conDiasRepetir!.map((x) => x)),
        "conAsignacion":
            List<dynamic>.from(conAsignacion!.map((x) => x.toMap())),
        "conUser": conUser,
...
class ConAsignacion {
  ...
  factory ConAsignacion.fromJson(String str) =>
      ConAsignacion.fromMap(json.decode(str));
  ...
  factory ConAsignacion.fromMap(Map<String, dynamic> json) => ConAsignacion(
        ...
        trabajos: json["trabajos"] == null
            ? null
            : List<dynamic>.from(json["trabajos"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "trabajos": trabajos == null
            ? null
            : List<dynamic>.from(trabajos!.map((x) => x)),
      };
}
...
class ConFotosCliente {
  ...
  factory ConFotosCliente.fromJson(String str) =>
      ConFotosCliente.fromMap(json.decode(str));
